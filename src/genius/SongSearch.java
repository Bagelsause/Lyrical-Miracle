...
public class SongSearch {
    ...
    public SongSearch(genius.GLA gla2, String query) throws IOException {
        this.gla = gla2;
    ...
    public SongSearch(genius.GLA gla, String query, int page) throws IOException {
        this.gla = gla;
        query = URLEncoder.encode(query, StandardCharsets.UTF_8.toString());
        try {
